...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
		    <div class="row">
		    	<div class="col-lg-12">
	            	<h1 class="page-header"><i class="fa fa-envelope-square" aria-hidden="true"></i> 收件箱&nbsp;&nbsp;<span>(共${mrilist.size()} 封邮件)</span></h1>
				</div>
		   	</div>
		   	<form action="mRdelete" method="post">
			   <div class="row">
			        <div class="col-lg-12">
					                                       ...
					                                       <c:if test="${c.isread==1}">
					                                        ...
					                                        <td class="center"><a href="reply?eid=${c.employee.id}&mid=${c.id}">${c.message.title} <span class="font-con">- - </span>
						                                        <span>
					                                            	...
					                                            	<c:if test="${c.message.content.indexOf('--------------原邮件-----------')!=-1 }">
					                                            		 ${c.message.content.substring(0,c.message.content.indexOf("--------------原邮件-----------"))}
					                                            	</c:if>
					                                            </span>
					                                        </a>
					                                        </td>
