...
<body>
   ...
   <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                    <thead>
                                         <tr role="row">
                                            <th tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width:83px;"><input id="ckbAll" type="checkbox"/> 全选</th>
                                    ...
                                    <tbody>
                                      <c:forEach var="c" items="${mlist}" >
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td class="center"><a href="replyTwo?id=${c.id}">${c.sendTime}</a></td>
                                          	 <c:if test="${c.level==1}">
    ...
    $(function() {
    	...
    	if($('.font-con').next().val().indexOf(str)){
    		alert(str);
    	}
