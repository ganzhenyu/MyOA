		                ...
		                <div class="panel-body">
		                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
		                        <div class="row">
		                            <div class="col-sm-8">
		                                <div class="pan-center">
		                                    <dl>
		                                        <dt> <i class="fa fa-tags"></i> ${mrById.message.title} </dt>
		                                        <dd>发件人：${mrById.message.employee.name} <i class="fa fa-user"></i></dd>
		                                        <dd class="dtime">时间：${mrById.message.sendTime}</dd>
		                                        <dd>收件人：${mrById.employee.name}</dd>
		                                        <dd>重要性：<c:if test="${mrById.message.level==1}">
		                        ...
		                        <div class="row">
		                            <div class="col-sm-12">
		                            <p class="hei"> </p>
		                            	<textarea id="content" name="topic.content" class="ckeditor form-control">${mrById.message.content}</textarea>
		                            </div>
		                        </div>
		                    </div>
		                </div>
